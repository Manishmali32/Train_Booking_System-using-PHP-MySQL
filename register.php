...
if(isset($_POST['register'])){
    ...
    $otp=rand(1111,9999);
    $otp_exp=date('Y-m-d H:i:s', time()+ 1800);
   $html="$otp is your otp";
    ...
    if( $result->num_rows > 0 ){
        ...
        $sql="INSERT INTO `user` (`username`, `password`, `first_name`, `middle_name`, `last_name`, `gender`, `date_of_birth`, `email`, `mobile_number`, `area`, `pincode`, `city`, `state`,`otp`,`exp_otp`) VALUES ( '$uname', '$pass', '$fname', '$mname', '$lname', '$gender', '$dob', '$email', '$phno', '$area', '$pin', '$city', '$state','$otp','$otp_exp')";
        ...
        if($sql==TRUE){
            ...
            $mail->SMTPSecure="tls";
            $mail->SMTPAuth=true;
            $mail->Username="malimanish7a@gmail.com";
            $mail->Password="iutrsuhafzzjredh";
            $mail->SetFrom("malimanish7a@gmail.com");
...
<form action="" name="regForm" onsubmit="return(validation());" method="post" class="bg-light">
    ...
    <!-- 10th row -->
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="text-main input-group">
             <input  class ="form-control" type="text" name="add_city">
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <div class="text-main input-group">
                    <input class="form-control" type="text" name="add_state" >
                </div>
